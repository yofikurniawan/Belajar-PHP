...
// mendefinisikan fungsi untuk menangani eksepsi
function exception_handler($eksepsi) {
  echo $eksepsi->getMessage() . "<br />";
}

// menentukan fungsi exception_handler() sebagai parameter
// dari fungsi set_exception_handler()
